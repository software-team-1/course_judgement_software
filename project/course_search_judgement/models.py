...
class judgement_system(models.Model):
    ...
    recommend_mark = models.DecimalField(max_digits=1, decimal_places=0)  # 推荐程度
    hard_core_mark = models.DecimalField(max_digits=1, decimal_places=0)  # 硬核程度
    mark_of_interest = models.DecimalField(max_digits=1, decimal_places=0)  # 无聊程度
